...
async def entrypoint(ctx: JobContext):
    ...
    logger.info(f"Starting AI Interview Agent with real-time subtitles in room: {ctx.room.name}")
    ...
    session = AgentSession(
        ...
        tts=elevenlabs.TTS(model="eleven_multilingual_v2", voice_id="EXAVITQu4vr4xnSDxMaL"),
